...
},{"./lib/topojson/bind":4,"./lib/topojson/clockwise":7,"./lib/topojson/filter":11,"./lib/topojson/prune":14,"./lib/topojson/simplify":16,"./lib/topojson/topology":19,"./topojson":30}],4:[function(require,module,exports){
...
},{"../../":3,"./type":29}],5:[function(require,module,exports){
...
},{"../../":3,"./coordinate-systems":9,"./type":29}],8:[function(require,module,exports){
...
},{"./cartesian":6,"./spherical":17}],10:[function(require,module,exports){
...
},{"../../":3,"./clockwise":7,"./coordinate-systems":9,"./prune":14,"./type":29}],12:[function(require,module,exports){
...
},{"../../":3,"./coordinate-systems":9}],17:[function(require,module,exports){
var π = Math.PI,
    π_4 = π / 4,
    radians = π / 180;
...
},{"./type":29}],19:[function(require,module,exports){
var type = require("./type"),
...
},{"./bounds":5,"./compute-id":8,"./coordinate-systems":9,"./delta":10,"./geomify":12,"./prefilter":13,"./quantize":15,"./stitch":18,"./topology/index":24,"./transform-properties":28,"./type":29}],20:[function(require,module,exports){
...
},{"./join":25}],21:[function(require,module,exports){
var join = require("./join"),
...
},{"./hashtable":23,"./join":25,"./point-equal":26,"./point-hash":27}],22:[function(require,module,exports){
...
},{"./cut":20,"./dedup":21,"./extract":22,"./hashtable":23}],25:[function(require,module,exports){
var hashtable = require("./hashtable"),
    hashPoint = require("./point-hash"),
    equalPoint = require("./point-equal");
...
},{"./hashtable":23,"./point-equal":26,"./point-hash":27}],26:[function(require,module,exports){
...
var d3=require("d3"),topojson=require("topojson"),globe=require("./globe"),radius=200,projection=d3.geo.orthographic().scale(radius-2).clipAngle(90).translate([radius,radius]),canvas=d3.select(".market .info").append("canvas").attr("width",2*radius).attr("height",2*radius),c=canvas.node().getContext("2d"),path=d3.geo.path().projection(projection).context(c),title=d3.select(".market .info .title");globe(function(t,e,n,a){var i=d3.select(".market .field .input").append("select"),o=i.selectAll("option").data(n).enter().append("option");o.text(function(t){return t.name});var r=function(){if(this.selectedIndex){var i=n[this.selectedIndex];d3.transition().duration(1250).each("start",function(){title.text(i.name)}).tween("rotate",function(){var n=d3.geo.centroid(i),o=d3.interpolate(projection.rotate(),[-n[0],-n[1]]);return function(n){projection.rotate(o(n)),c.clearRect(0,0,2*radius,2*radius),c.fillStyle="#bbb",c.beginPath(),path(e),c.fill(),c.fillStyle="#f00",c.beginPath(),path(i),c.fill(),c.strokeStyle="#fff",c.lineWidth=.5,c.beginPath(),path(a),c.stroke(),c.strokeStyle="#000",c.lineWidth=2,c.beginPath(),path(t),c.stroke()}})}};i.on("change",r)});
},{"./globe":32,"d3":1,"topojson":3}],32:[function(require,module,exports){
...
},{"d3":1,"queue-async":2,"topojson":3}]},{},[31])