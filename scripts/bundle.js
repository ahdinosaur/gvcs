...
},{"./lib/topojson/bind":8,"./lib/topojson/clockwise":11,"./lib/topojson/filter":15,"./lib/topojson/prune":18,"./lib/topojson/simplify":20,"./lib/topojson/topology":23,"./topojson":34}],8:[function(require,module,exports){
...
},{"../../":7,"./type":33}],9:[function(require,module,exports){
...
},{"../../":7,"./coordinate-systems":13,"./type":33}],12:[function(require,module,exports){
...
},{"./cartesian":10,"./spherical":21}],14:[function(require,module,exports){
...
},{"../../":7,"./clockwise":11,"./coordinate-systems":13,"./prune":18,"./type":33}],16:[function(require,module,exports){
...
},{"../../":7,"./coordinate-systems":13}],21:[function(require,module,exports){
var π = Math.PI,
    π_4 = π / 4,
    radians = π / 180;
...
},{"./type":33}],23:[function(require,module,exports){
var type = require("./type"),
...
},{"./bounds":9,"./compute-id":12,"./coordinate-systems":13,"./delta":14,"./geomify":16,"./prefilter":17,"./quantize":19,"./stitch":22,"./topology/index":28,"./transform-properties":32,"./type":33}],24:[function(require,module,exports){
...
},{"./join":29}],25:[function(require,module,exports){
var join = require("./join"),
...
},{"./hashtable":27,"./join":29,"./point-equal":30,"./point-hash":31}],26:[function(require,module,exports){
...
},{"./cut":24,"./dedup":25,"./extract":26,"./hashtable":27}],29:[function(require,module,exports){
var hashtable = require("./hashtable"),
    hashPoint = require("./point-hash"),
    equalPoint = require("./point-equal");
...
},{"./hashtable":27,"./point-equal":30,"./point-hash":31}],30:[function(require,module,exports){
...
var d3=require("d3"),topojson=require("topojson"),queue=require("queue-async");module.exports=function(e){function o(o,n,t){{var r={type:"Sphere"},u=topojson.feature(n,n.objects.land),s=topojson.feature(n,n.objects.countries).features,a=topojson.mesh(n,n.objects.countries,function(e,o){return e!==o});s.length}s=s.filter(function(e){return t.some(function(o){return e.id==o.id?e.name=o.name:void 0})}).sort(function(e,o){return e.name.localeCompare(o.name)}),e(r,u,s,a)}queue().defer(d3.json,"data/world-110m.json").defer(d3.tsv,"data/world-country-names.tsv").await(o)};
},{"d3":1,"queue-async":3,"topojson":7}],36:[function(require,module,exports){
var d3=require("d3"),topojson=require("topojson"),$=jQuery=require("jquery");require("./vendor/jquery-easing"),require("semantic/src/modules/accordion"),require("semantic/src/modules/dimmer"),require("semantic/src/modules/modal"),$(function(){$(".ui.accordion").accordion(),$(".ui.login.modal").modal("attach events",".login.button","show"),$(".ui.login.modal .actions .submit").click(function(){window.location.href="./compass.html"}),$(".ui.signup.modal").modal("attach events",".signup.button","show"),$(".ui.signup.modal .actions .submit").click(function(){window.location.href="./compass.html"}),$("body").attr("style","background: -webkit-linear-gradient(to left, #444, #fff, #444); background: -moz-linear-gradient(to left, #444, #fff, #444); background: -ms-linear-gradient(to left, #444, #fff, #444); background: -o-linear-gradient(to left, #444, #fff, #444); background: linear-gradient(to left, #444, #fff, #444); background: -webkit-radial-gradient(circle, #fff, #444); background: -moz-radial-gradient(circle, #fff, #444); background: -o-radial-gradient(circle, #fff, #444); background: radial-gradient(circle, #fff, #444);")});var globe=require("./globe"),projection=d3.geo.orthographic().clipAngle(90),t0=Date.now(),canvas=d3.select("body").insert("canvas",":first-child").attr("class","background"),updateWindow=function(){var t=window,e=document,i=document.documentElement,n=e.getElementsByTagName("body")[0],o=t.innerWidth||i.clientWidth||n.clientWidth,a=t.innerHeight||i.clientHeight||n.clientHeight,r=o/2,c=a/2,l=Math.min(r,c);canvas.attr("width",2*l).attr("height",2*l),canvas.attr("style","left: "+(o/2-l)+"px;"),projection.translate([l,l]),projection.scale(l)};window.onresize=updateWindow,updateWindow();var path=d3.geo.path().projection(projection),velocity=.002;globe(function(t,e,i,n){d3.timer(function(){var i=Date.now()-t0,o=canvas.node().getContext("2d"),a=path.context(o),r=velocity*i;projection.rotate([r,0,0]),o.clearRect(0,0,canvas.attr("width"),canvas.attr("height")),o.fillStyle="#d4ffff",o.lineWidth=2,o.beginPath(),a(t),o.fill(),o.fillStyle="#d4c4aa",o.beginPath(),a(e),o.fill(),o.strokeStyle="#fff",o.lineWidth=.5,o.beginPath(),a(n),o.stroke(),o.strokeStyle="#666",o.lineWidth=2,o.beginPath(),a(t),o.stroke()})});
},{"./globe":35,"./vendor/jquery-easing":37,"d3":1,"jquery":2,"semantic/src/modules/accordion":4,"semantic/src/modules/dimmer":5,"semantic/src/modules/modal":6,"topojson":7}],37:[function(require,module,exports){
